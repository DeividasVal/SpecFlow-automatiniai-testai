...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/WS", "PriceChecker", "price checker for webserver", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("TC165672")]
...
#line hidden
                ...
                table25.AddRow(new string[] {
                            ...
                            "0"});
#line 10
 testRunner.Then("user checks items by barcode and their values match:", ((string)(null)), table25, "Then ");
#line hidden
            }
...
#line hidden
#line 22
    testRunner.Then("app should return message \'Barcode not found or No patterns found for this barcod" +
                        "e length\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
